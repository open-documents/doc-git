...
>参考：https://javaguide.cn/java/basis/java-basic-questions-02.html#string

# String、StringBuffer、StringBuilder 的区别

## 可变性

先说结论：String 是不可变的，StringBuffer、StringBuilder是可变的。

为什么说String 是不可变的？下面两个原因造成了String内部的值不可改变，如果重新赋值，会分配新的内存，然后将指针指向新的对象。
- 保存字符串的数组被 `final` 修饰且为私有的，并且`String` 类没有提供/暴露修改这个字符串的方法。
- `String` 类被 `final` 修饰导致其不能被继承，进而避免了子类破坏 `String` 不可变。

为什么说StringBuffer、StringBuilder是可变的？
...
```
上面的代码对应的字节码如下：
![[Pasted image 20240223172638.png]]
...
![[Pasted image 20240223172737.png]]
...
![[Pasted image 20240223172817.png]]
...
```
对应的字节码：
![[Pasted image 20240223173125.png]]
...
```
对应的字节码：
![[Pasted image 20240223173212.png]]
...
![[Pasted image 20240223174235.png]]
